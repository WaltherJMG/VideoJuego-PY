...
class ModeEasy:
    def __init__(self):
        # título de modo de juego
        self.tipoLetra = pygame.font.Font(None, 80)
        self.titulo = self.tipoLetra.render("Modo Facil", True, (255, 255, 255))
        self.titulo_rect = self.titulo.get_rect(center=(ancho // 2, 200))

        # botón Back definido como Rect (x, y, ancho, alto)
        self.btn_back = pygame.Rect(10, 10, 50, 50)  # cuadrado para el botón

    def ejecutarModeEasy(self):
        try:
            while True:
